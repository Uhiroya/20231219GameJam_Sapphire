...
{
    [SerializeField] CanvasGroup _winCanvasGroup;
    [SerializeField] RectTransform rectTransform;
    [SerializeField] float _endPositionY = 0;
    [SerializeField] float _whitePanelAnimationTime = 0;
    ...
    public void StartCreditAnimation()
    {
        _winCanvasGroup.DOFade(1.0f, _whitePanelAnimationTime).OnComplete(() =>
            rectTransform.DOAnchorPos(new Vector2(0, _endPositionY), _animationTime).OnComplete(() =>
            {
